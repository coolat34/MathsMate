...
.padding()
.font(.title2)
Text("**Always evaluate in this order**\n1st, evaluate values in the brackets.\n2nd, evaluate values that have an exponent.\n3rd and 4th, evaluate Division or Multiplication values.\n5th and 6th, evaluate Addition or Subtraction values").font(.title2)
