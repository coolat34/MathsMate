            ...
            HStack(spacing: 1) {
                ...
                .sheet(isPresented: $showButton) {
                    QuestionAnswerView(exercises1_11: Array(
                        ExerciseBank1_11.shared.simplify[0..<5]), mathsTopic: mathsTopic)
                } /// sheet
            } /// Hstack
            } /// Scroll
